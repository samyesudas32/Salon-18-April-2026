  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; padding: 40px; border: 1px solid #eee; border-radius: 12px; color: #1a1a1a;">
        <h2 style="color: #2563eb; margin-bottom: 24px;">Password Reset</h2>
        <p>Hello,</p>
        <p>A request was made to reset your administrative password for <strong>${businessName}</strong>.</p>
        <p>If you did not make this request, you can safely ignore this email.</p>
        <div style="margin: 32px 0;">
          <a href="${resetLink}" style="background-color: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block;">Reset Password Now</a>
        </div>
